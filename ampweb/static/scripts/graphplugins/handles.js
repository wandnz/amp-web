 ...
 *
 * This is a version of the handles plugin that includes bugfixes for the
 * positionDrag() and positionScroll() methods, which previously did not take
 * plotOffset into account.
 *
 * Options
