/** Smokeping style timeseries graph **/
Flotr.addType('smokeping', {
    options: {
    ...
    /**
     * Plot a smokeping style line graph:
     *      http://oss.oetiker.ch/smokeping/doc/reading.en.html
     *
     * - draw line graph based on median values, colour based on loss
     * - for each segment on the graph, fill the area above/below it based
     *   on range of other measured values
     */
